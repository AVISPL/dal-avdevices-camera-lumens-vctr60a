...
public enum Command {
	...
	HUE_CURRENT( "Picture", "HueCurrentValue", null),
	SATURATION( "Picture", "Saturation", new byte[] { 0x49 }),
	SATURATION_CURRENT( "Picture", "SaturationCurrentValue", null),
	BRIGHTNESS( "Picture", "Brightness", new byte[] { 0x4D }),
	BRIGHTNESS_CURRENT( "Picture", "BrightnessCurrentValue", null),
	SHARPNESS( "Picture", "Sharpness", new byte[] { 0x42 }),
	SHARPNESS_CURRENT( "Picture", "SharpnessCurrentValue", null),
	GAMMA( "Picture", "Gamma", new byte[] { 0x5B }),
	GAMMA_CURRENT( "Picture", "GammaCurrentValue", null),
	...
	RGAIN_CURRENT( "WhiteBalance", "ManualRedCurrentValue", null),
	RGAIN_INQ( "WhiteBalance", "ManualRedCurrentValue", new byte[] { 0x43 }),
	BGAIN( "WhiteBalance", "ManualBlue", new byte[] { 0x44 }),
	BGAIN_CURRENT( "WhiteBalance", "ManualBlueCurrentValue", null),
	BGAIN_INQ( "WhiteBalance", "ManualBlueCurrentValue", new byte[] { 0x44 }),
